...
- An **Environment variables** section (after the usage block) documents `PS_ADMIN_TOKEN`, `INSTANCE_ID`, `POWERSYNC_ENVIRONMENT`, and `API_URL` for script/CI use, with a short example.

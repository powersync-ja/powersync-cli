...
/**
 * Validate the cloud config against the JSON schema
 */
...
/**
 * Validate the self-hosted config against the JSON schema
 */
...
/**
 * Validate the either cloud or self-hosted config against the JSON schema
 */
...
/**
 * Validate the link config against the JSON schema
 */
